...
class JobOrderListRepresentationNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    ...
    {
        if ($type !== 'BenBorla\\JobAdder\\V2\\Model\\JobOrderListRepresentation') {
            return false;
        }
    ...
    {
        if ($data instanceof \BenBorla\JobAdder\V2\Model\JobOrderListRepresentation) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \BenBorla\JobAdder\V2\Model\JobOrderListRepresentation();
        ...
        if (property_exists($data, 'items')) {
            ...
            foreach ($data->{'items'} as $value) {
                $values[] = $this->serializer->deserialize($value, 'BenBorla\\JobAdder\\V2\\Model\\JobOrderSummaryModel', 'raw', $context);
            }
