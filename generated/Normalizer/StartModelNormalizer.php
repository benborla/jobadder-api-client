...
class StartModelNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    ...
    {
        if ($type !== 'BenBorla\\JobAdder\\V2\\Model\\StartModel') {
            return false;
        }
    ...
    {
        if ($data instanceof \BenBorla\JobAdder\V2\Model\StartModel) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \BenBorla\JobAdder\V2\Model\StartModel();
        ...
        if (property_exists($data, 'relative')) {
            $object->setRelative($this->serializer->deserialize($data->{'relative'}, 'BenBorla\\JobAdder\\V2\\Model\\RelativeStartModel', 'raw', $context));
        }
