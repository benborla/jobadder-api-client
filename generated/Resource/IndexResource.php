...
class IndexResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\BenBorla\JobAdder\V2\Model\ResourcesRepresentation
     */
    public function resources($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'BenBorla\\JobAdder\\V2\\Model\\ResourcesRepresentation', 'json');
            }
        }
