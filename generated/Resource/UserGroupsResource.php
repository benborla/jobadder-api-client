...
class UserGroupsResource extends Resource
{
     ...
     *
     * @return \Psr\Http\Message\ResponseInterface|\BenBorla\JobAdder\V2\Model\UserGroupListRepresentation
     */
    public function findUserGroups($parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'BenBorla\\JobAdder\\V2\\Model\\UserGroupListRepresentation', 'json');
            }
        }
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\BenBorla\JobAdder\V2\Model\UserGroupRepresentation
     */
    public function getUserGroup($groupId, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'BenBorla\\JobAdder\\V2\\Model\\UserGroupRepresentation', 'json');
            }
        }
     ...
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface|\BenBorla\JobAdder\V2\Model\UserListRepresentation
     */
    public function getGroupUsers($groupId, $parameters = [], $fetch = self::FETCH_OBJECT)
    {
        ...
        if (self::FETCH_OBJECT == $fetch) {
            if ('200' == $response->getStatusCode()) {
                return $this->serializer->deserialize((string) $response->getBody(), 'BenBorla\\JobAdder\\V2\\Model\\UserListRepresentation', 'json');
            }
        }
